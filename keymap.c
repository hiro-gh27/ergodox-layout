 ...
 * !-------+-----+-----+-----+-----+-------------! !-------+-----+-----+-----+-----+-----+-------!
 * |  TAB  |  Q  |  W  |  E  |  R  |  T  | MO(2) | ! MO(2) |  Y  |  U  |  I  |  O  |  P  | BSLS  |
 * !-------+-----+-----+-----x-----x-----!       ! !       !-----x-----x-----+-----+-----+-------!
 * | LCTL  |  A  |  S  |  D  |  F  |  G  |-------! !-------!  H  |  J  |  K  |  L  |SCLN | QUOT  |
 * !-------+-----+-----+-----x-----x-----! MO(1) ! ! MO(1) !-----x-----x-----+-----+-----+-------!
 * | LSFT  |  Z  |  X  |  C  |  V  |  B  |       | !       |  N  |  M  |COMM | DOT |SLSH | RSFT  |
 * '-------+-----+-----+-----+-----+-------------' '-------------+-----+-----+-----+-----+-------'
 *  | LALT | GRV |QUOT |BSLS |LANG2|                             !LANG1|LPRN |RPRN |LBRC | RBRC |
 *  '------------------------------'                             '------------------------------'
 *                               .---------------. .---------------.
 *                               | LEFT  | DOWN  | !  UP   | RIGHT |
 *                       .-------+-------+-------! !-------+-------+-------.
 *                       !  SPC  ! LGUI  | LGUI  | !  DEL  |  ENT  !  SPC  !
 *                       !       !       !-------! !-------!       !       !
 *                       |       |       | LANG2 | ! LANG1 |       |       |
 *                       '-----------------------' '-----------------------'
...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
  ...
  KC_LALT,      KC_GRV,  KC_QUOT,  KC_BSLS,  KC_LANG2,

                                                 KC_LEFT, KC_DOWN,
                                                          KC_LGUI,
                                      KC_SPC,  KC_LGUI,   KC_LANG2,
  ...
  MO(1),   KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,   KC_RSFT,
                     KC_LANG1, KC_LPRN,  KC_RPRN,  KC_LBRC,   KC_RBRC,
